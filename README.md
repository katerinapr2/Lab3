...
**Κριτική**  
Η συγκεκριμένη εργαστηριακή άσκηση, σαν συνέχεια των προηγούμενων, έδινε μια ολοκληρωμένη εικόνα για την προσoμοίωση συστημάτων και την μελέτη τους. Συγκεκριμένα, κατανοήσαμε την έννοια της ενεργειακής αποδοτικότητας στους επεξεργαστές ....
