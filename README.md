...
***Leakage power***  
Η κατανάλωση ισχύος λόγω διαρροής προέρχεται από το μικρο-επίπεδο στα τρανζίστορ. Μικρές ποσότητες ρευμάτων ρέουν πάντα μεταξύ των διαφορετικών τμημάτων του τρανζίστορ. Το μέγεθος αυτών των ρευμάτων εξαρτάται από την κατάσταση του τρανζίστορ, τις διαστάσεις του, τις φυσικές ιδιότητες και τη θερμοκρασία. Η συνολική ποσότητα ρεύματος διαρροής τείνει να διογκώνεται για αύξηση της θερμοκρασίας και μείωση των μεγεθών τρανζίστορ. 
~~~
...
* του Activity factor, γιατί διαφορετικές αλλαγές προκαλλούν διαφορετική δραστηριότητα των transistor, γεγονός που προκαλεί την αλλαγή του Dynamic Power.  
...
δίνει ισάξια ζωή μπαταρίας.Το mcpat δεν παρέχει κάποιο στατιστικό που να αναφέρεται στο ρυθμό επεξεργασίας των δεδομένων, οπότε δεν μπορούμε να βγάλουμε κάποιο συμπέρασμα. Σε περίπτωση που θα θέλαμε να μελετήσουμε τη διάρκεια ζωής της μπαταρίας, θα χρησιμοποιούσαμε τα αποτελέσματα του gem5 σχετικά με τον χρόνο προσομοίωσης.    
...
Τα πιθανά σφάλματα που προκύπτουν στην παραπάνω ανάλυση οφείλονται στους παρακάτω παράγοντες:
Το γεγονός ότι χρησιμοποιούμε δύο διαφορετικούς simulator για την ανάλυση διαφορετικών πτυχών του συστήματος επιφέρει αυξημένο αριθμό σφαλμάτων στην ανάλυση καθώς για κάθε λάθος που προκύπτει σε ένα στάδιο (π.χ gem5) αυτό θα πολλαπλασιαστεί στα επόμενα (π.χ mcpat). Συγκεκριμένα, ο gem5 παρουσιάζει σφάλματα στην προσομοίωση της κύριας μνήμης και κυρίως στον τρόπο αναπαράστασης του latency για κάθε προσπέλαση αυτής, ενώ για το mcpat, τα σφάλματα που προκύπτουν οφείλονται είτε στο ελλιπές μοντέλο μιας δομής,για παράδειγμα στον μοντέλο του επεξεργαστή δεν συμπεριλαμβάνονται δομές όπως οι IFU, ISU και LSU,  είτε εξαιτίας του ότι οι παράμετροι είναι high-level και δε μπορούν να αναπαραστήσουν επακριβώς ένα low-level σύστημα. Γενικά, μπορούμε να συμπεράνουμε ότι όσο περισσότερα στάδια εικονικής ανάλυσης προσθέτουμε (simulations) τα αποτελέσματα θα απομακρύνονται από αυτά που θα προέκυπταν από την απευθείας ανάλυση του πραγματικού συστήματος. Τέλος, λάθη προκύπτουν και από τις πιθανές στρογγυλοποιήσεις που συμβαίνουν κατά την εκτέλεση των προσομοιώσεων.   

**Κριτική**  
Η συγκεκριμένη εργαστηριακή άσκηση, σαν συνέχεια των προηγούμενων, έδινε μια ολοκληρωμένη εικόνα για την προσoμοίωση συστημάτων και την μελέτη τους. Συγκεκριμένα, κατανοήσαμε την έννοια της ενεργειακής αποδοτικότητας στους επεξεργαστές και με ποιον τρόπο αυτή επιτυγχάνεται αλλάζοντας τις παραμέτρους αυτών.
