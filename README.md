...
**2.** Η _χωρητικότητα_ της μπαταρίας μετριέται σε _μονάδες ρεύματος * μονάδες χρόνου_ και η _ισχύς_ των επεξεργαστών αποτελούν ενέργεια ανά μονάδα χρόνου.Έπειτα απο αντικαταστάσεις είναι εύκολο να διακρίνουμε οτι η ζωή της μπαταρίας καταναλώνεται με ρυθμό 40 φορές μεγαλύτερο για τον ενεργοβόρο επεξεργαστή.
